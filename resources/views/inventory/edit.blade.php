	...
	<div class="panel-body">
		<form method="post" action="{{ route('inventory.update', [encrypt($user->id), $inventory->id]) }}">
			...
			<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
				<input type="text" name="name" class="form-control" placeholder="Name" required autofocus value="{{ $inventory->name }}">
                @if ($errors->has('name'))
			...
			<div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
				<input type="text" name="price" class="form-control" placeholder="Unit Price" required value="{{ $inventory->price }}">
				@if ($errors->has('price'))
                    <span class="help-block">
            ...
            <div class="form-group{{ $errors->has('qty') ? ' has-error' : '' }}">
				<input type="text" name="qty" class="form-control" placeholder="Quantity" required value="{{ $inventory->qty }}">
				@if ($errors->has('qty'))
                    <span class="help-block">
            ...
            <div class="form-group{{ $errors->has('date_reorder') ? ' has-error' : '' }}">
				<input type="text" name="date_reorder" class="form-control" placeholder="Date Reordered" id="datepicker" required value="{{ $inventory->date_reorder }}">
